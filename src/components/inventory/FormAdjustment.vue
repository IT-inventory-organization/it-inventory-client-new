      ...
      <v-form ref="initialReport" @submit.prevent="handleSubmit">
        <v-container fluid>
              ...
              <v-row no-gutters>
                ...
                <v-col cols="8">
                  <v-text-field
                    ...
                    :rules="[
                      value => {
                        return genericRequiredRule(value, 'Nomor Adjustment');
                      }
                    ]"
                  ></v-text-field>
                </v-col>
              ...
              <v-row no-gutters>
                ...
                <v-col cols="8">
                  <v-text-field
                    ...
                    :rules="[
                      value => {
                        return genericRequiredRule(value, 'Tanggal Adjustment');
                      }
                    ]"
                  ></v-text-field>
                </v-col>
          ...
          <v-row no-gutters class="mt-10">
            <button
              @click.prevent="add"
              style="background-color: white; border-radius: 1em; padding: 0.5em 1em 0.5em 0.8em; display: flex; align-items: center;"
            >
              <img src="@/assets/icons/ic_upload.svg" />
              <span style="padding: 0 0 0 0.5em;text-decoration: underline;">
                Upload Fiile Surat Persetujuan</span
              >
            </button>
          </v-row>
        </v-container>
